...
namespace Michsky.UI.ModernUIPack
{
    public class WindowDragger : UIBehaviour, IBeginDragHandler, IDragHandler
    {
        ...
        public new void Start()
        {
            if (dragObject == null)
            {
                dragObject= this.gameObject.transform.GetComponent<RectTransform>();
            }
            ...
            if (dragArea == null)
            {
                try
                {
                    ...
                    dragArea = this.gameObject.transform.parent.GetComponent<RectTransform>();
                }
        ...
        //Jitu testing
        public new void LoosenUp()
        {
            GameObject floatingSpace = GameObject.Find("FloatingCanvas");
            this.gameObject.transform.SetParent(floatingSpace.transform);
            dragArea = floatingSpace.transform.GetComponent<RectTransform>();
