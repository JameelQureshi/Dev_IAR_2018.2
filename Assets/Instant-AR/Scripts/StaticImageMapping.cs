...
public class StaticImageMapping : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //TargetImage targetImageObject = ARUtilityTools.getTargetImageFromUID("169bcd3fc83b4e828012b1c3121c814c");
        ...
        for (int i = 0; i < 100; i++)
        {
            ...
            if (!string.IsNullOrEmpty(tempButtonInfo))
            {
                ...
                if (!string.IsNullOrEmpty(targetInfo.sizeRatio))
                {
                    ...
                    //Debug.Log("<color=red> @@@@@@ JITENDER sizeRatio  </color>" + sizeRatio);
                }


                GameObject buttonPrefab = (GameObject)Resources.Load("StaticInfoButton");
                ...
                changeSprite(newButton, targetInfo);
                //Debug.Log("<color=red> ################## After   changeSprite</color>" );

                //=====================

                StaticInfoButtonScript staticInfoButtonScript = newButton.GetComponent<StaticInfoButtonScript>();
                staticInfoButtonScript.string_value1 = targetInfo.string_value1;
                staticInfoButtonScript.string_value2 = targetInfo.string_value2;
                staticInfoButtonScript.string_value3 = targetInfo.string_value3;
    ...
    public void changeSprite(GameObject go, TargetInfo targetInfo)
    {
        string spritePath = targetInfo.button_sprite;
        Debug.Log("<color=red> ##################   spritePath is: </color>"+ spritePath);
        ...
        if (!string.IsNullOrEmpty(targetInfo.string_value1) && targetInfo.string_value1.ToLower().Equals("equipmentno"))
        {
            if (!string.IsNullOrEmpty(targetInfo.string_value3))
            {
                if (targetInfo.string_value3.ToLower().Equals("green"))
                {
                    ...
                    thisButton.GetComponentInChildren<Text>().text = targetInfo.string_value2;
                }
        ...
        else if (!string.IsNullOrEmpty(targetInfo.string_value3))
        {
            thisButton.GetComponentInChildren<Text>().text = targetInfo.string_value3;
        }
